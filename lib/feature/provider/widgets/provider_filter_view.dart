                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: Get.height*0.35,
                        child: ListView.builder(itemBuilder: (context,index){
                          return Padding(
                            ...
                            child: CustomCheckBox(title:  providerBookingController.categoryList[index].name??"",
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: CustomButton(buttonText: 'reset'.tr,backgroundColor: Theme.of(context).hintColor.withOpacity(0.5),
