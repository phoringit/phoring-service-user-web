            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: ResponsiveHelper.isDesktop(context)? Get.height*0.5:Get.height*0.9,
                    child: Center(
                        child: Text('no_provider_found'.tr,style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).textTheme.titleSmall!.color!.withOpacity(0.7)),)),
                ),
              ],
            ),
          ),
