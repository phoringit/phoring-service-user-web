  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: methodList!.map((method) => Padding(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Flexible(child: Text(' :  ${method.data}', style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium?.color?.withOpacity(0.8)),overflow: TextOverflow.ellipsis,)),
      ]),
    )).toList());
  }
}
