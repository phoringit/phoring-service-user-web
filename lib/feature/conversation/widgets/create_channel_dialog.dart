                          ...
                          TextButton(
                            onPressed:(){
                              if(provider.chatEligibility == true){
                                ...
                                Get.find<ConversationController>().createChannel(provider.id!, bookingDetails?.id ?? "",name: name,image: image,fromBookingDetailsPage: true,phone: phone,userType: "provider");
                              }else{
