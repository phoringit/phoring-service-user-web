      ...
      child: Row(
        ...
        children: [
          Expanded(
            flex: 4,
            child: Text(title.tr ,
              style: robotoMedium.copyWith(color: Theme.of(Get.context!).textTheme.bodySmall?.color?.withOpacity(0.7)),
            ),
          ),
          const Expanded(
            child: SizedBox(),
...
class ReviewCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          if(!transparent) Align(alignment: Alignment.centerLeft, child: Text("reviews".tr, style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(.6),fontSize: Dimensions.fontSizeDefault))),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Text(
              ...
              style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(.5), fontSize: Dimensions.fontSizeSmall),
