        ...
        InkWell(
          ...
          child: Container(
            decoration: BoxDecoration(color: color ?? Theme.of(context).cardColor,
              ...
              border: Border.all(color: color != null ? Colors.transparent : Theme.of(context).hintColor.withOpacity(0.15)),
            ),
            ...
            Row(children: [
              ...
              Directionality(textDirection: TextDirection.ltr,
                child: Text(
                  ...
                  style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodySmall?.color?.withOpacity(0.6)),
                ),
              )
            ]),
