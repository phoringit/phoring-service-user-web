          ...
          child: Stack(alignment: Alignment.center, children: [
            ...
            Column(
              ...
              children: [
                ...
                Text('no_provider_found_to_your_related_filter'.tr,style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).textTheme.titleSmall!.color!.withOpacity(0.7)),),
              ],
            ),
          ]),
        ),
