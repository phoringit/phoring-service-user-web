                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  ...
                                  style: robotoRegular.copyWith(color: color,fontSize: Dimensions.fontSizeExtraSmall,),
                                ),
                              ],
                            ),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('follow_us_on'.tr, style: robotoRegular.copyWith(color: color,fontSize: Dimensions.fontSizeExtraSmall)),
                                SizedBox(height: 50,
