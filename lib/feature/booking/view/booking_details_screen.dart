...
class BookingDetailsScreen extends StatefulWidget {
  ...
  const BookingDetailsScreen({super.key,  this.bookingID,  this.fromPage,  this.phone, this.subBookingId,
  }) ;
...
class _BookingDetailsScreenState extends State<BookingDetailsScreen> with SingleTickerProviderStateMixin {
  ...
  @override
  void initState() {
    if(widget.bookingID !=null || widget.subBookingId != null){
     ...
     onPopInvoked: (){
      ...
      child: Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child: widget.bookingID == null && widget.subBookingId == null ? const NoDataScreen(text: "no_data_found", type: NoDataType.bookings,) :
