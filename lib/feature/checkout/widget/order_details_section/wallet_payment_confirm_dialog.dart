        ...
        child: Padding(padding:  const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeLarge,horizontal: Dimensions.paddingSizeLarge),
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
              child: Text('note!'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
            ),
            ...
            RichText( text:
              TextSpan(children: <TextSpan>[
                TextSpan(
                  ...
                  style: robotoRegular.copyWith(color: Theme.of(Get.context!).textTheme.bodyLarge!.color!.withOpacity(0.9),height: 1.7),
                ),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center ,children: [
              ...
              const SizedBox(width : Dimensions.paddingSizeSmall),
              Text('booking_amount'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).textTheme.bodyMedium?.color?.withOpacity(0.8)), textAlign: TextAlign.center),

            ],),
            SizedBox(height: isPartialPayment ? Dimensions.paddingSizeExtraSmall : Dimensions.paddingSizeDefault),

            isPartialPayment ?
            Text('can_be_paid_via_wallet'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).textTheme.bodyMedium?.color?.withOpacity(0.5)), textAlign: TextAlign.center
            ):
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text('remaining_wallet_balance'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).textTheme.bodyMedium?.color?.withOpacity(0.6)), textAlign: TextAlign.center),
              Text(PriceConverter.convertPrice(walletBalance-bookingAmount),style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).textTheme.bodyMedium?.color?.withOpacity(0.6))),
