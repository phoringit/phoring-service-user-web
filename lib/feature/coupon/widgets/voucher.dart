                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Wrap(runAlignment: WrapAlignment.start,children: [
                    Text(
                      ...
                      style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(.5)),
                    ),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(couponModel.discount!.endDate.toString(),
                              style: robotoBold.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(.6), fontSize: 12))
                        ],
                      ),
