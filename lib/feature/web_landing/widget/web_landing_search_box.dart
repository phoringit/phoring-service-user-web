              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(widget.textContent?['web_top_title']??"",style: robotoBold.copyWith(fontSize: Dimensions.fontSizeOverLarge,color: Colors.black),),
                                    ...
                                    children: [
                                      ...
                                      Expanded(child: TypeAheadField(
                                        ...
                                        builder: (context, controller, focusNode) {
                                          return TextField(
                                            ...
                                            style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: dark.primaryColor.withOpacity(0.8),)
                                          );
                                        },
                                      ...
                                      InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Center(child: Text('set_location'.tr,style: robotoMedium.copyWith(
                                            color: Colors.white,
                                            fontSize: Dimensions.fontSizeSmall,),)),
                                        ),
                                      ),
